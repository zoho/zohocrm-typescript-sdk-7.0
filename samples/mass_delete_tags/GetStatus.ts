...
class GetStatus {
    static async getStatus() {
        ...
        paramInstance.add(ZOHOCRMSDK.DeleteMassTags.GetStatusParam.JOB_ID, "3477022003");

        const response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.DeleteMassTags.StatusResponseHandler.MasterModel> = await massDeleteTagsOperations.getStatus(paramInstance);
