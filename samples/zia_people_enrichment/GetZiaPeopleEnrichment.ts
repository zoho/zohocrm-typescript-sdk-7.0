...
class GetZiaPeopleEnrichment{
    static async getZiaPeopleEnrichment(ziaPeopleEnrichmentId: bigint) {
        ...
        const response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.EnrichmentPeopleZia.ResponseHandler.MasterModel> = await ziaPeopleEnrichmentOperations.getZiaPeopleEnrichment(ziaPeopleEnrichmentId);
            ...
            if (responseHandler instanceof ZOHOCRMSDK.EnrichmentPeopleZia.ResponseWrapper) {
                ...
                if (ziapeopleenrichment != null) {
                    for (const ziapeopleenrichment1 of ziapeopleenrichment) {
                        const enrichedData: ZOHOCRMSDK.EnrichmentPeopleZia.EnrichedData = ziapeopleenrichment1.getEnrichedData();

                        if (enrichedData != null) {
                            console.log('ZiaPeopleEnrichment EnrichedData Website: ' + enrichedData.getWebsite());

                            const emailInfos: ZOHOCRMSDK.EnrichmentPeopleZia.EmailInfo[] = enrichedData.getEmailInfos();
                            if (emailInfos != null) {
                            ...
                            const companyInfo: ZOHOCRMSDK.EnrichmentPeopleZia.CompanyInfo = enrichedData.getCompanyInfo();
                            if (companyInfo != null) {
                                console.log('ZiaPeopleEnrichment EnrichedData CompanyInfo Name: ' + companyInfo.getName());

                                const industries: ZOHOCRMSDK.EnrichmentPeopleZia.Industry[] = companyInfo.getIndustries();
                                if (industries != null) {
                                ...
                                const experiences: ZOHOCRMSDK.EnrichmentPeopleZia.Experience[] = companyInfo.getExperiences();
                                if (experiences != null) {
                            ...
                            const addressListInfo: ZOHOCRMSDK.EnrichmentPeopleZia.Address[] = enrichedData.getAddressListInfo();
                            ...
                            const primaryAddressInfo: ZOHOCRMSDK.EnrichmentPeopleZia.Address = enrichedData.getPrimaryAddressInfo();
                            ...
                            const socialMedia: ZOHOCRMSDK.EnrichmentPeopleZia.SocialMedia[] = enrichedData.getSocialMedia();
                            if (socialMedia != null) {
                        ...
                        const enrichBasedOn: ZOHOCRMSDK.EnrichmentPeopleZia.EnrichBasedOn = ziapeopleenrichment1.getEnrichBasedOn();
                        if (enrichBasedOn != null) {
                            const social: ZOHOCRMSDK.EnrichmentPeopleZia.Social = enrichBasedOn.getSocial();
                            if (social != null) {
                            ...
                            const company: ZOHOCRMSDK.EnrichmentPeopleZia.Company = enrichBasedOn.getCompany();
                            if (company != null) {
