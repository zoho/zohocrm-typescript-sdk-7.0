...
class UpdateDuplicateCheckPreference {
    static async updateDuplicateCheckPreference(moduleAPIName: string) {
        ...
        const typeConfigurations: ZOHOCRMSDK.CheckDuplicatePreference.TypeConfiguration[] = [];
        ...
        const fieldMappings: ZOHOCRMSDK.CheckDuplicatePreference.FieldMappings[] = [];
        ...
        const response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.CheckDuplicatePreference.ActionHandler.MasterModel> = await duplicateCheckPreferenceOperations.updateDuplicateCheckPreference(request);
