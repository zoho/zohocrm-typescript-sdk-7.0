...
- Install **TypeScript SDK**
    ...
    ```
- The TypeScript SDK will be installed and a package named **@zohocrm/typescript-sdk-7.0** will be created in the local machine.
...
export class CustomStore implements ZOHOCRMSDK.TokenStore.MasterModel {
    ...
    /**
     *
     * @param {Token} token A Token (@zohocrm/typescript-sdk-7.0/models/authenticator/oauth_token) class instance.
