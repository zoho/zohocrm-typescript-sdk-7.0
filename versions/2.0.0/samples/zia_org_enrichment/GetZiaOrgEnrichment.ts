...
class GetZiaOrgEnrichment {
    static async getZiaOrgEnrichment(ziaOrgEnrichmentId: bigint) {
        ...
        const response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.EnrichmentOrgZia.ResponseHandler.MasterModel> = await ziaOrgEnrichmentOperations.getZiaOrgEnrichment(ziaOrgEnrichmentId);
        ...
        if (response !== null) {
            ...
            if (responseHandler instanceof ZOHOCRMSDK.EnrichmentOrgZia.ResponseWrapper) {
                const responseWrapper = responseHandler as ZOHOCRMSDK.EnrichmentOrgZia.ResponseWrapper;
                ...
                const exception = responseHandler as ZOHOCRMSDK.EnrichmentOrgZia.APIException;
