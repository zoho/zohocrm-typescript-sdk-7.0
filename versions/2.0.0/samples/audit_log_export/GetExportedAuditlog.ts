...
class GetExportedAuditlog {
    static async getExportedAuditlog(Id: bigint): Promise<void> {
        ...
        if (response !== null) {
            ...
            if (responseHandler instanceof ZOHOCRMSDK.AuditExportLog.ResponseWrapper) {
                ...
                const exception = responseHandler as ZOHOCRMSDK.AuditExportLog.APIException;
    ...
    private static printCriteria(criteria: ZOHOCRMSDK.AuditExportLog.Criteria): void {
